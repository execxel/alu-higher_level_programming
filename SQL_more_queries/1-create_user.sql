...
-- Grant the explicit privilege set to match expected grants output
...
GRANT APPLICATION_PASSWORD_ADMIN, AUDIT_ADMIN, BACKUP_ADMIN,
	...
	ENCRYPTION_KEY_ADMIN, FLUSH_OPTIMIZER_COSTS, FLUSH_STATUS,
	...
	TABLE_ENCRYPTION_ADMIN, XA_RECOVER_ADMIN ON *.* TO 'user_0d_1'@'localhost';
FLUSH PRIVILEGES;
